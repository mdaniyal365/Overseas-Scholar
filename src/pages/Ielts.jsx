          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="my-4">
              <div className="flex items-center justify-center md:block">
                <button className="bg-yellow-to-orange cursor-pointer text-white px-12 py-2 font-bold text-[20px] rounded md:p-4 pb">
                  Try Free MasterclassName
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col py-10 gap-4 rounded-2xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4">
              <div className="py-4 md:py-8">
                <div className="flex flex-col items-center justify-center border-[#E8E8E8] px-4 ">
                  <img
                    ...
                    src="https://d14lg9nzq1d3lc.cloudfront.net/avataran/avataran_assets/images/ielts/featuresSection/students_trained_icon.svg"
                  />
                  <div className="text-center font-bold text-[#0A0926] md:text-[18px] md:px-4">
                    Learn from India's top IELTS Trainers
                  </div>
                </div>
              </div>
              <div className="py-4 md:py-8">
                <div className="flex flex-col items-center justify-center border-[#E8E8E8] px-4 ">
                  <img
                    ...
                    src="https://d14lg9nzq1d3lc.cloudfront.net/avataran/avataran_assets/images/ielts/featuresSection/bands_Icon.svg"
                  />
                  <div className="text-center font-bold text-[#0A0926] md:text-[18px] md:px-4">
                    90% score 7+ bands
                  </div>
              ...
              <div className="py-4 md:py-8">
                <div className="flex flex-col items-center justify-center border-[#E8E8E8] px-4 ">
                  <img
                    ...
                    src="https://d14lg9nzq1d3lc.cloudfront.net/avataran/avataran_assets/images/ielts/featuresSection/average_student_rating_icon.svg"
                  />
                  <div className="text-center font-bold text-[#0A0926] md:text-[18px] md:px-4">
                    Average student rating of 4.5/5
                  </div>
                </div>
              </div>
              <div className="py-4 md:py-8">
                <div className="flex flex-col items-center justify-center border-[#E8E8E8] px-4 ">
                  <img
                    ...
                    src="https://d14lg9nzq1d3lc.cloudfront.net/avataran/avataran_assets/images/ielts/featuresSection/pan_india_community.svg"
                  />
                  <div className="text-center font-bold text-[#0A0926] md:text-[18px] md:px-4">
                    PAN India community
                  </div>
