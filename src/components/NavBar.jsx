...
<body className="bg-blue-500">
	<nav className="relative px-4 py-4 flex justify-between items-center bg-white">
		<a className="text-3xl font-bold leading-none" href="#">
			<img src={logo} className="h-10" alt="logo" viewBox="0 0 10240 10240"/>
				
		</a>
		<div className="lg:hidden">
			<button onClick={()=>{isOpen(!open)}}className="navbar-burger flex items-center text-blue-600 p-3 ">
		...
		<ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
			...
			<li><a className="text-sm text-gray-400 hover:text-gray-500" href="#">Study Abroad
			...
			<li><a className="text-sm text-gray-400 hover:text-gray-500" href="#">IELTS</a></li>
			<li className="text-gray-300">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
				</svg>
		...
		<nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
			<div className="flex items-center mb-8">
				<a className="mr-auto text-3xl font-bold leading-none" href="#">
					<img src={logo} className="h-12" alt="logo" viewBox="0 0 10240 10240"/>
				        
			        
				</a>
				<button onClick={()=>{isOpen(!open)}} className="navbar-close">
			...
			<div>
				<ul>
					...
					<li className="mb-1">
						<a className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Study Abroad

</a>
					</li>
					<li className="mb-1">
						<a className="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">IELTS</a>
					</li>
					<li className="mb-1">
